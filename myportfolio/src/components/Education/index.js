...
const Education = (props) => {
  const { educationHistory } = props.fields;
  return (
    <div>
                ...
                <div className="col-md-6 col-sm-12 col-xs-12">
                  <div className="content-left">
                    <div className="title-resume">
                      ...
                      <h2>
                        <Text field={props.fields.learning}></Text>&nbsp;
                        <span>
                          <Text field={props.fields.university}></Text>
                        </span>
                      </h2>
                    </div>
                  </div>
                ...
                <div className="col-md-6 col-sm-12 col-xs-12">
                  <div className="content-right">
                    <ul className="timeline">
                      {educationHistory &&
                        educationHistory.map((listItem, index) => (
                          <li key={`educationHistory-${index}`}>
                            <h4>
